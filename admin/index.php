...
<footer id="main-footer" class="mt-5">
    <div class=" foot-container bg-dark">
        ...
        <div id="site-link" class="foot-item bg-dark">
            <p class=" text-center"><a class="text-white" href="/project/admin/allorder.php">Orders</a></p>
            <p class="text-white text-center"><a class="text-white" href="transaction.php">Payment</a></p>
            <p class="text-white text-center"><a class="text-white" href="comment.php">All comments</a></p>
        </div>
